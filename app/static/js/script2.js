...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function init() {
        ...
        if (datetimeElement) {
            datetimeElement.textContent = '2025-06-05 09:39:32';
        }
    ...
    function initializeSampleUsers() {
        salesUsers = [
            ...
            { id: "8", name: "soheruINFO", email: "soheruinfo@example.com", role: "admin" }
        ];
    ...
    // Assign lead to team member - UPDATED TO USE LOCAL STORAGE
    function assignLead() {
    ...
    function renderLeadsTable() {
        try {
            ...
            leads.forEach(lead => {
                ...
                const formattedDate = typeof createdDate === 'string' ? 
                    new Date(createdDate).toLocaleString() : 'Unknown';
    ...
    function viewLeadDetails(leadId) {
        try {
            ...
            if (lead.assigned_to) {
                ...
                const assignmentDate = lead.assignment_date ? 
                    new Date(lead.assignment_date).toLocaleString() : 
                    'Unknown date';
    ...
    async function loadSalesUsers() {
       ...
       // Assign lead to team member with specific role - USING API
    async function assignLead() {
        ...
        try {
            ...
            // Store in database using API endpoint
            ...
            if (leadIndex >= 0) {
                ...
                allLeads[leadIndex].assignment_notes = notes;
                allLeads[leadIndex].assigned_to_name = username;
                allLeads[leadIndex].assignment_date = savedAssignment.created_at;
                allLeads[leadIndex].assigned_by = currentUser.username;
            }
            ...
            if (currentLeadIndex >= 0) {
                ...
                leads[currentLeadIndex].assignment_notes = notes;
                leads[currentLeadIndex].assigned_to_name = username;
                leads[currentLeadIndex].assignment_date = savedAssignment.created_at;
                leads[currentLeadIndex].assigned_by = currentUser.username;
            }
