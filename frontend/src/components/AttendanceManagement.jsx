...
import { 
  ...
  Download, Eye, Edit, Trash2, AlertCircle, User, Users
} from 'lucide-react';
...
const AttendanceManagement = () => {
  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      ...
      setStats({
        totalPresent: mockData.filter(r => r.status === 'present').length,
        totalAbsent: mockData.filter(r => r.status === 'absent').length,
        totalLate: mockData.filter(r => r.checkin_time > '09:00:00').length,
        attendanceRate: 95
      });
    } catch (error) {
